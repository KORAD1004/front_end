...
const Section01 = () => {
  ...
  return (
    <div className={styles.allContainer}>
      <AnimationLayout>{renderQuiz()}</AnimationLayout>
      ...
      <div className={styles.mainTextContainer}>
        <p className={styles.mainSmallText}>
          KORAD 퀴즈 풀고 AI 맞춤 코스 확인 👀
        </p>
      ...
      <div className={styles.courseButtonContainer}>
        <button className={styles.courseButton} onClick={handleCourseSelect}>
          코스선택하기
        </button>
      </div>
    </div>
