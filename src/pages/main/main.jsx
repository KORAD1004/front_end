  ...
  return (
    <div className={styles["app-container"]}>
      ...
      <div
        ...
        style={!isDesktop ? { backgroundImage: `url(${bac2})` } : null}
      >
      ...
      <div className={styles["image-container"]}>
          ...
          >
            {images.map((image, index) => (
              <SwiperSlide
                key={image.id}
                onClick={() =>
                  handleImageClick(swiperRef.current.swiper, index)
                }
              >
                <img
                  loading="lazy"
        ...
        <p className={styles["middle-comment1"]}>
          *본 소개지는 &lsquo;한국원자력환경공단&rsquo; 인근 핫플레이스로,
          사회적 갈등을 대화와 타협, 민주적 방식으로 극복해낸 역사적 모범사례로
          대표합니다.
        </p>
      </div>
      ...
      <div className={styles["middle-container"]}>
        <div className={styles["safety-container"]}>
          <img
            loading="lazy"
            src={isDesktop ? safety2 : safety}
            className={styles["safety"]}
            alt="safety"
          />
          <div className={styles["sc-container"]}></div>
          <img
            loading="lazy"
            src={check}
      ...
      <div className={styles["map-container"]}>
        <div className={styles["mc-container"]}>
          <p className={styles["map-comment"]}>
            <span className={styles["mc1"]}>경화주월</span>
            <br />
            <br />
            <span className={styles["mc2"]}>안전관리 역량이 단단한 경주를</span>
            <br />
      ...
      <div className={styles["bottom-box"]}>
        ...
        <p className={styles["bottom-comment3"]}>
          본 웹앱은 한국원자력환경공단의 대표 공공데이터 API를 활용해
          기획했습니다.
        </p>
      </div>
    </div>
