    ...
    <div className={styles["app-container"]}>
      <div className={styles["top-container"]}>
        ...
        <div className={styles["top-box"]}>
          <img loading='lazy' src={topboxback} className={styles["topboxback"]} alt="top box background" />
        </div>
        <img loading='lazy' src={topback} className={styles["topback"]} alt="top back" />
      ...
      <div className={styles["rad-container"]}>
        <img loading='lazy' src={rad} className={styles["rad"]} alt="radiation" />
      ...
      <div className={styles["ne-container"]}>
        <img loading='lazy' src={ne} className={styles["ne"]} alt="negative" />
      ...
      <div className={styles["image-container"]}>
        ...
        <p className={styles["eightcomment"]}>
          한국방사성폐기물관리공단’에서 <span className={styles["highlight2"]}>&lsquo;한국원자력환경공단&rsquo;으로</span><br/> 사명변경이 최종 의결되는 과정을 거쳐 명칭이 변경되었습니다.
        </p>
      ...
      <div className={styles["care-container"]}>
        <img loading='lazy' src={care} className={styles["care"]} alt="care" />
      ...
      <div className={styles["tower-container"]}>
        <img loading='lazy' src={tower} className={styles["tower"]} alt="tower" />
        <img loading='lazy' src={promise} className={styles["promise"]} alt="promise" />
      ...
      <div className={styles["i-container"]}>
        <img loading='lazy' src={impossible} className={styles["impossible"]} alt="impossible" />
        ...
        <img loading='lazy' src={graph} className={styles["graph"]} alt="graph" />
        ...
        <img loading='lazy' src={gback} className={styles["gback"]} alt="gback" />
      </div>
    </div>
  );
}
