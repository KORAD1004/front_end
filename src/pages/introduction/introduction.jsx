  ...
  return (
    <div className={styles["app-container"]}>
      ...
      ‘방사성’과 ‘폐기물’이라는 단어가 주는 <span className={styles["highlight2"]}>부정적 이미지를 해소하고</span><br /> 
       방사성폐기물처리장을 유치한 경주시민의 요구에 따라 <br />
        </p>
      </div>
      ...
      <div className={styles["image-container"]}>
        ...
        <p className={styles["carecomment"]}>고준위 방사성 폐기물 처분시설 부지선정, 기술개발, 인력양성 등
        ...
        정부는 2004년 주민투표제를 토입하고<br/><span className={styles["highlight3"]}>중저준위방사성폐기물 처분시설 유치지역에 관한 특별법</span>을 제정하였습니다.
        ...
        이후 2015년 7월 중저준위방사성폐기물을 지하 사일로에 최초처분하였습니다.<br/><br/><span className={styles["highlight3"]}>2015년 8월 28일 준공식읠 개최했으며,<br/>현재까지 대한민국의 원자력 사용에 중요한 역할을 도맡고 있습니다.</span>
          </p>
      </div>
    </div>
  );
